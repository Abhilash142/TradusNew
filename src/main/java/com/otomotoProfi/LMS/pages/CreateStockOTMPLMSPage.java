...
public class CreateStockOTMPLMSPage {
	...
	@FindBy(xpath = "//label[contains(.,'fitsTo')]/parent::div/descendant::input")
	...
	@FindBy(xpath = "//span[contains(.,'PLN')]/parent::li")
	public WebElement currencyTypeasPLN;
	...
	@FindBy(xpath = "(//span[contains(.,'Volvo')]/parent::li)[1]")
	public WebElement vehicleMakeasVolvo;
	
	@FindBy(xpath = "(//span[contains(.,'JCB')]/parent::li)[1]")
	...
	@FindBy(xpath = "//div[@class='w-2/5' and contains(.,'fitsTo')]/parent::div//span")
	...
	public CreateStockOTMPLMSPage(RemoteWebDriver driver) throws Exception {
		this.driver = driver;
		PageFactory.initElements(driver, this);
		loadUrl(driver,"https://sprzedawca.otomotoprofi.pl/lms/ads/create");
	}
