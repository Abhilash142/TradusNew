...
public class LoginOtomotoProfiLMSPage {
	...
	@FindBy(xpath = "//span[text()='Overview']/parent::a")
	...
	public LoginOtomotoProfiLMSPage(RemoteWebDriver driver) throws Exception {
		this.driver = driver;
		PageFactory.initElements(driver, this);
		loadUrl(driver,"https://sprzedawca.otomotoprofi.pl/login");
		/*explicitWaitFortheElementTobeVisible(driver,passwordTextField);
	...
	public void setAccountEmailAndPassword(String email,String password) throws Exception {
		explicitWaitFortheElementTobeVisible(driver,languageDropdown);
		actionClick(driver,languageDropdown);
		waitTill(1000);
		actionClick(driver,englishOptioninLangDropdown);
