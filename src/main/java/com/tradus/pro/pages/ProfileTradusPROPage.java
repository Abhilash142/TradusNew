...
public class ProfileTradusPROPage {
	...
	public List<WebElement> contactPersonTextField;
	...
	@FindBy(xpath = "//span[text()='Are you available on WhatsApp?']/parent::div//button[contains(@class, 'switch-active')]")
	public WebElement enabledWhatsappToggler;
	...
	public WebElement companyNameFieldDangerText;
	...
	public List<WebElement> contactPersonFieldDangerText;
	...
	public ProfileTradusPROPage(RemoteWebDriver driver) throws Exception {
		this.driver = driver;
