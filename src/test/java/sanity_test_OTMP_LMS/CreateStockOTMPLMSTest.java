...
public class CreateStockOTMPLMSTest extends BaseClass {
	...
	/*
	 * Description: Verify 'Create' and 'All' links are displaying on clicking My stock link in menu
	 */
	@Test
	public void verifyCreateandAllLinksaredisplayingOnClickingMyStockinMenu() throws Exception {
		...
		explicitWaitFortheElementTobeVisible(driver, overviewPage.createMyStockOptioninSiderBar);
	...
	/*
	 * Description: Verify page is redirecting to create page on clicking create link in the menu
	 */
	@Test
	public void verifyPageisRedirectingtoCreatePageonClickingCreateLink() throws Exception {
		...
		jsClick(driver, overviewPage.myStockOptioninSiderBar);
		explicitWaitFortheElementTobeVisible(driver, overviewPage.createMyStockOptioninSiderBar);
		jsClick(driver, overviewPage.createMyStockOptioninSiderBar);
		explicitWaitFortheElementTobeVisible(driver, overviewPage.createStockPageVerificationElement);
		Assert.assertTrue(verifyElementPresent(overviewPage.createStockPageVerificationElement),
				"Create stock page isn't displaying on clicking from side menu");
	}
	...
	/*
	 * Description: Verify error message on trying to post the ad without filling mandatory fields
	 */
	@Test
	...
	public void verifyErrorOnGivingInvalidConstructionYear() throws Exception {
		...
		Assert.assertTrue(getText(createStockObj.errorToastInPostingForm).contains("The attributes.construction year must be between 1900 and 2020."), 
				"Success toast not displayed after inserting an ad");
		sendKeys(createStockObj.constructionYearAreainPostingForm, "2022");
		jsClick(driver, createStockObj.postYourAdButton);
		explicitWaitFortheElementTobeVisible(driver, createStockObj.errorToastInPostingForm);
		Assert.assertTrue(getText(createStockObj.errorToastInPostingForm).contains("The attributes.construction year must be between 1900 and 2020."), 
				"Success toast not displayed after inserting an ad");
