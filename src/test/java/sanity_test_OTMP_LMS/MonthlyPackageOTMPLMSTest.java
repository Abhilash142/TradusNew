...
public class MonthlyPackageOTMPLMSTest extends BaseClass{
	 ...
	 */
	@Test
	public void verifySelectedPackagewhileSignupisDisplayingunderYourActivePackage() throws Exception {
	    ...
	    Assert.assertTrue(getText(pkgObj.selectedPackageTitle).equals("5 listings"), "Selected package during sign up isn't displaying in Packages page");
	...
	public void validateSubscribedPackageinsightText() throws Exception {
	    ...
	    Assert.assertTrue(getText(pkgObj.selectedPackageInsights).replace("\n", ",").trim().equals("5 listings,55,80 zł,Per listing,279,00 zł per month"), "Package insights under subscribed package isn't displaying");
	}
	...
	public void verifyPageisRedirectingroActivatePackageoageonClickingByPackagePage() throws Exception {
		...
		loadUrl(driver,"https://sprzedawca.otomotoprofi.pl/lms/monthly-package");
	    }
	}
